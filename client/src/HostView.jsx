...
const WHEEL_COLORS=["#e33b2e","#218d4f","#218d4f","#1769ae","#e33b2e","#e8c53e","#218d4f","#1769ae","#e33b2e","#e8c53e","#218d4f","#1769ae","#e33b2e","#218d4f","#1769ae","#e33b2e","#e8c53e","#218d4f","#1769ae","#218d4f"];
const WHEEL_BACKGROUND=`radial-gradient(circle,#d7b44b 0 16%,#17120e 16% 20%,transparent 20%),conic-gradient(${WHEEL_COLORS.map((color,index)=>`${color} ${index*18}deg ${(index+1)*18}deg`).join(",")})`;
