...
export const ADDITIONAL_GRAND_PRIZES = [
  ["LG","83-inch OLED evo television",4499,"One ultra-large 4K OLED smart television with high-refresh gaming and Dolby Vision."],
  ["Samsung","65-inch OLED television",2499,"One 4K OLED smart television with glare reduction and a 120-hertz display."],
  ["Sony","4K laser home projector",4999,"One premium laser projector with native 4K processing and high dynamic range."],
  ["Apple","MacBook Pro laptop computer",3499,"One professional laptop with a high-resolution display and solid-state storage."],
  ["ASUS","ROG gaming desktop computer",3999,"One high-performance gaming computer with advanced graphics and liquid cooling."],
  ["Canon","EOS full-frame mirrorless camera",3299,"One full-frame mirrorless camera with high-resolution still and 4K video capture."],
  ["Nikon","Z-series mirrorless camera",2499,"One weather-sealed mirrorless camera with in-body image stabilization."],
  ["DJI","Mavic professional camera drone",2999,"One folding aerial camera drone with stabilized high-resolution video."],
  ["Ernie Ball Music Man","Cory Wong StingRay II electric guitar",4525,"One premium electric guitar with a contoured body and signature electronics."],
  ["Yamaha","Clavinova digital piano",3999,"One weighted-key digital piano with a graded keyboard and concert-grand sampling."],
  ["Roland","Electronic drum kit",2999,"One professional electronic drum kit with mesh heads and a performance sound module."],
  ["Fender","American Professional electric guitar",2699,"One American-made electric guitar with modern pickups and a contoured body."],
  ["GE Profile","French-door refrigerator",3599,"One full-size French-door refrigerator with flexible storage and an ice maker."],
  ["Bosch","Benchmark dishwasher",2199,"One quiet stainless-steel dishwasher with adjustable racks and precision drying."],
  ["KitchenAid","Commercial-style gas range",4699,"One professional-style kitchen range with convection cooking and six burners."],
  ["LG","Front-load washing machine",1499,"One high-capacity front-load washer with steam cycles and smart controls."],
  ["Miele","Complete C3 canister vacuum",1399,"One premium canister vacuum with sealed filtration and adjustable suction."],
  ["Breville","Oracle Touch espresso machine",3499,"One automatic espresso machine with an integrated grinder and steam wand."],
  ["Napoleon","Prestige PRO gas barbecue",2999,"One Canadian-designed premium gas grill with infrared burners and illuminated controls."],
  ["Weber","Summit Kamado grill",1699,"One insulated charcoal grill with a large cooking surface and hinged lid."],
  ["Cub Cadet","Three-stage snow blower",2499,"One self-propelled snow blower with power steering and electric start."],
  ["EGO","Two-stage cordless snow blower",2299,"One battery-powered snow blower with dual-port power and variable-speed augers."],
  ["John Deere","S100 riding lawn tractor",3999,"One riding lawn tractor with a hydrostatic transmission and a 42-inch cutting deck."],
  ["Husqvarna","Automower robotic lawn mower",2999,"One GPS-assisted robotic mower designed for large and complex lawns."],
  ["DeWalt","Professional cabinet table saw",2499,"One heavy-duty cabinet saw with a precision fence and enclosed dust port."],
  ["Festool","Track saw",1899,"One precision plunge-cut track saw with variable speed and dust extraction."],
  ["Honda","Inverter generator",3499,"One quiet portable generator with fuel-efficient inverter power."],
  ["Nova Craft","Prospector Canadian canoe",3999,"One Canadian-made composite canoe designed for lakes and wilderness travel."],
  ["Pelican","Catch fishing kayak",1499,"One stable sit-on-top fishing kayak with an adjustable seat and gear storage."],
  ["Trek","Allant electric bicycle",4499,"One long-range electric bicycle with pedal assist and an integrated battery."],
  ["NordicTrack","Commercial treadmill",2999,"One folding treadmill with incline control and a large interactive display."],
  ["Concept2","RowErg rowing machine",1499,"One commercial-grade indoor rower with adjustable air resistance and performance tracking."],
  ["BowFlex","Max Trainer elliptical",2499,"One compact elliptical trainer with adjustable resistance and guided workouts."],
  ["Tempur-Pedic","King-size memory-foam mattress",4999,"One premium king-size mattress with pressure-relieving memory foam."],
  ["Palliser","Power reclining chair",2999,"One Canadian-made leather recliner with powered headrest and lumbar adjustment."],
  ["EQ3","Canadian-designed leather sofa",3999,"One full-size leather sofa with a kiln-dried wood frame."],
  ["Herman Miller","Aeron office chair",2199,"One ergonomic office chair with adjustable posture support and breathable suspension."],
  ["Celestron","EdgeHD computerized telescope",3999,"One computerized telescope with precision tracking and an advanced optical tube."],
  ["BERNINA","Computerized sewing machine",2499,"One premium sewing machine with automatic threading and a colour touchscreen."],
  ["Prusa","XL 3D printer",2699,"One large-format multi-tool 3D printer with automatic calibration."],
].map(([brand,name,price,description])=>({brand,name,price,description,image:null,imageVerified:false,category:"grand",singlePrize:true}));
